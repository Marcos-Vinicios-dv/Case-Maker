...
export const Container = styled.section`
  ...
  ${backgroundImages(
    `url(${Back})`,
    'radial-gradient(#323C47 10%, #222C38 50%, #202A36 60%)'
  )};
...
export const PC = styled.div`
  ...
  animation: fade 0.6s cubic-bezier(0.39, 0.575, 0.565, 1) 1.3s both;
...
export const CustomButton = styled.button`
  ...
  animation: fadeInBack 0.6s cubic-bezier(0.39, 0.575, 0.565, 1) 1.3s both;
...
export const MainText = styled.div`
  ...
  span {
    font-size: 3em;
    animation: slideLetters 0.6s cubic-bezier(0.39, 0.575, 0.565, 1) 0.7s both;
  }
